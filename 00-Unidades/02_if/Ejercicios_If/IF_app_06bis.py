...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        altura_num = int(altura_txt)
        mensaje = "Tu posición en la cancha es de: "

        if altura_num < 160:
            mensaje = "Tu posición en la cancha es de: Base"
        elif altura_num <= 179:
            mensaje = "Tu posición en la cancha es de: Escolta"
        elif altura_num <= 199:
            mensaje = "Tu posición en la cancha es de: Alero"
        else:
            mensaje = "Tu posición en la cancha es de: Ala-Pívot o Pívot"
